...
const googleCallback = async (req, res) => {
  ...
  try {
    ...
    // Meeting-link authorization runs in a popup. Notify the schedule form and
    // close the popup instead of navigating the partner into the student flow.
    if (statePayload?.purpose === "create-meeting") {
