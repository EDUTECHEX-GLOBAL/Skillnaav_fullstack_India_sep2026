...
const userwebappSchema = new mongoose.Schema(
  {
    ...
    planType: {
      type: String,
      enum: ["Free", "Freemium", "Premium Basic", "Premium Plus"],
      default: "Free",
    },
    premiumExpiration: { type: Date, default: null },
    // Tracks when the current subscription period started — used for per-period application counting
    applicationPeriodStart: { type: Date, default: null },
